...
Delete Vacancy
    Go to Vacancies page
    Select From List By Label    //select[@id='vacancySearch_hiringManager']    ${HIRING_MANAGER}
    Click Button                 //input[@id='btnSrch']
    Table Cell Should Contain    //table[@id='resultTable’]	2	2                 Automation Tester needed
